CREATE DATABASE  IF NOT EXISTS `missa` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `missa`;
...
INSERT INTO `manager` VALUES (1,'罌粟小子','1','1'),(2,'WhistleBaby','whistle','baby'),(3,'FreddyFazbear','ur','urur');
...
INSERT INTO `product` VALUES (1,'猴子',1,'中央大學',12497,100),(2,'猴子',1,'中原大學',16696,100),(3,'猴子',1,'元智大學',8763,100),(4,'松果',2,'中央大學',75000,20),(5,'松果',2,'中原大學',1000,20),(6,'松果',2,'元智大學',2000,20),(7,'美食',3,'中央大學',50,200),(8,'美食',3,'中原大學',1000,200),(9,'美食',3,'元智大學',3,200);
...
INSERT INTO `supplier` VALUES (1,'家'),(2,'大自然'),(3,'攤販');
...
INSERT INTO `tbl_warhouse_product` VALUES (1,1),(2,2),(3,3),(1,4),(2,5),(3,6),(1,7);
...
INSERT INTO `warhouse` VALUES ('一號倉庫','中央大學',1),('二號倉庫','中原大學',2),('三號倉庫','元智大學',3);
